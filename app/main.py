...
app.include_router(transaction_details_router, prefix="/transaction_details", tags=["Transaction Details"])
app.include_router(transaction_failures_router, prefix="/transaction_failures", tags=["Transaction Failures"])
